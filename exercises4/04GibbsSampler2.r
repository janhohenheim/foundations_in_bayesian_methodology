####################################
# STA421 FBM FS24: 04Worksheet Exercise 2
# Version 2: Includes the computation of descriptive statistics
# from marginal posterior distributions provided by INLA.
####################################
